...
Updated: 2026-09-23
Task-ID: T007
Status: synthetic_expansion_complete_real_corpus_open
...
已完成候选模型许可证审计、离线 Transformers.js 接入、固定 revision/hash 的本地中文模型、query instruction、异步作者工作流、HTTP smoke 和合成中文检索基准。合成基准覆盖语义/精确查询各 5 次重复、Policy Gate、provenance、构建与增量成本；结果与自然语料严格分开。用户正文与衍生题集仅保留在本地；远端提交不含私人语料、路径或具体私人结果。

当前仍未满足“生产级真实语料”收敛：需要用户自有或明确许可的自然小说式文本、独立人工相关性标注、多次运行分布和 lexical exact boost 是否需要产品决策。没有这些证据，不能关闭 T007，也不能把合成结果称为生产质量。
